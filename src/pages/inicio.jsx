...
<a className='links' href="/src/pages/entrar.jsx">Entrar</a>
<a className='links' href="/src/pages/registrar.jsx">Resgistrar</a>
</div>

        <div className='Bem-vindo'>
          <h1>Bem Vindo ao Clark</h1>
<img className='Imagem-cachorro-juiz' height="350px" src="/src/assets/images/download (6).jpeg" alt="" />
